        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                child: Text('Search result for "Tiemo Ligera" '),
              ),
              const SizedBox(height: 10),
              Expanded(
                child: GridView.builder(
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      crossAxisSpacing: 5.0,    // Khoảng cách giữa cột trái và cột phải
                      mainAxisSpacing: 5.0,     // Khoảng cách giữa hàng trên và hàng dưới
                      childAspectRatio: 0.6,    // 👈 Tỷ lệ (Chiều rộng / Chiều cao) của thẻ.
